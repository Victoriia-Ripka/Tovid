...
stf = {(0, 'Letter'): 1, (1, 'Letter'): 1, (1, 'Digit'): 1, (1, 'other'): 2,
       (0, 'Digit'): 3, (3, 'Digit'): 3, (3, 'other'): 4, (3, 'dot'): 5, (5, 'Digit'): 6, (5, 'other'): 103,
       (6, 'Digit'): 6, (6, 'other'): 7, (6, '+'): 8, (8, 'Digit'): 8, (8, 'dot'): 9, (8, 'i'): 11, (9, 'Digit'): 10,
       (9, 'other'): 103, (10, 'Digit'): 10, (10, 'i'): 11,
...
def processing():
    ...
    if state == 2:
        ...
        if token != 'keyword':
            ...
            state = init_state
    if state in (4, 7, 11, 13, 14, 16, 17, 19, 20):
        lexeme += char
        token = get_token(state, lexeme)
        print('{0:<3d} {1:<10s} {2:<10s} '.format(num_line, lexeme, token))
        table_of_symb[len(table_of_symb)+1] = (num_line, lexeme, token, '')
